...
public class Consultations extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblOffence = new javax.swing.JLabel();
        lblDOO = new javax.swing.JLabel();
        txtStudentID = new javax.swing.JTextField();
        cmbOffence = new javax.swing.JComboBox<>();
        ...
        lblOfferr = new javax.swing.JLabel();
        ...
        filterOFF = new javax.swing.JMenu();
        sep5 = new javax.swing.JPopupMenu.Separator();
        OFF_HND = new javax.swing.JMenuItem();
        sep6 = new javax.swing.JPopupMenu.Separator();
        OFF_WNS = new javax.swing.JMenuItem();
        sep7 = new javax.swing.JPopupMenu.Separator();
        OFF_LNA = new javax.swing.JMenuItem();
        ...
        sortOFF = new javax.swing.JMenuItem();
        ...
        lblOffence.setForeground(new java.awt.Color(255, 255, 255));
        lblOffence.setText("Offence");
        ...
        cmbOffence.setBackground(new java.awt.Color(0, 0, 0));
        cmbOffence.setForeground(new java.awt.Color(0, 0, 153));
        cmbOffence.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Offence", "Homework Not Done", "Work Not Submitted", "Lesson Not Attended" }));
        cmbOffence.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbOffenceActionPerformed(evt);
            }
        });
        ...
        jTDisplay.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Offence", "Sanction", "Subject", "Parents Told", "Offence Date"
            }
        ));
        ...
        cmbSanction.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sanction", "None", "Awarded Zero", "Break Detention", "Friday Detention" }));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblOffence, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblDOO)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(lblOfferr))
                            .addComponent(cmbOffence, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(cmbOffence, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblOffence))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblOfferr)
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        filterOFF.setText("Offence");
        filterOFF.add(sep5);

        OFF_HND.setText("Homework not done");
        OFF_HND.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                OFF_HNDActionPerformed(evt);
            }
        });
        filterOFF.add(OFF_HND);
        filterOFF.add(sep6);

        OFF_WNS.setText("Work not submitted");
        OFF_WNS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                OFF_WNSActionPerformed(evt);
            }
        });
        filterOFF.add(OFF_WNS);
        filterOFF.add(sep7);

        OFF_LNA.setText("Lesson not attended");
        OFF_LNA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                OFF_LNAActionPerformed(evt);
            }
        });
        filterOFF.add(OFF_LNA);
        filterOFF.add(sep11);

        menuFilter.add(filterOFF);
        menuFilter.add(sep1);
        ...
        sortOFF.setText("Offence");
        sortOFF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sortOFFActionPerformed(evt);
            }
        });
        menuSort.add(sortOFF);
        menuSort.add(sep22);
        ...
        try
        {
            ...
            try(Scanner sc = new Scanner(new FileReader("temp.txt")))
            {
                ...
                try(Scanner ar = new Scanner(line).useDelimiter("#"))
                {
                    ...
                    if(log.getPosition().equals("Head of School") || log.getPosition().equals("Deputy Head of School"))
                    {
                        //disbale register and update buttons
    ...
    private void Sort(String order /*either ASC or DESC*/, String value /*Whatever value user wants to sort by*/)
    {
        ...
        jTDisplay.setModel(new DefaultTableModel(null, new String[]{"Student ID", "Offence", "Sanction","Subject","Parents Told","Offence Date"}));
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                user = new Cons(rs.getString("studentID"), rs.getString("Offence"), rs.getString("Sanction"), rs.getString("Subject"), rs.getString("ParentsTold"), rs.getString("DateOfOffence"));
                userList.add(user);
            }
        }
    ...
    private void Filter(String filter /*what you want to filter*/, String value/*filter condition*/)
    {
        ...
        try
        {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost/consultations", "root", "");
            String query = "SELECT * FROM conlog WHERE " + filter + " = '" + value + "'" + "ORDER BY ParentsTold ASC";
    ...
    private void Search(String item /*what you will search by*/, String value/*what you want to search for*/)
    {
        ...
        try
        {
            ...
            ResultSet rs = (con.createStatement()).executeQuery(query);
                ...
                while(rs.next())
                {
                    userList[num] = new Cons(rs.getString("studentID"), rs.getString("Offence"), rs.getString("Sanction"), rs.getString("Subject"), rs.getString("ParentsTold"), rs.getString("DateOfOffence"));
                    num++;
                }
    ...
    private void cmbOffenceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbOffenceActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbOffenceActionPerformed
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        if(opt == 0)
        {
            ...
            //Offence Checks
            //Presence Check
            //if offence not selected
            if(cmbOffence.getSelectedItem().toString().equals("Offence"))
            {
                //display message indicating error
                lblOfferr.setText("Offence must be selected*");
                lblOfferr.setForeground(r);
            }
            //if selected
            else
            {
            ...
            if(lblSIDerr.getText().equals("****") && lblOfferr.getText().equals("****") && lblSanerr.getText().equals("****") && lblSuberr.getText().equals("****") && lblPTerr.getText().equals("****") && lblDOOerr.getText().equals("****"))
            {
                //begin try-catch
                try
                {
                    String query = "INSERT INTO `conLog`(`StudentID`, `Offence`, `Sanction`, `Subject`, `ParentsTold`, `DateOfOffence`) VALUES (?, ?, ?, ?, ?, ?)";
                    ...
                    pst.setString(2, cmbOffence.getSelectedItem().toString());
    ...
    private void jTDisplayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTDisplayMouseClicked
        ...
        //display offence
        String offence = model.getValueAt(i, 1).toString();
        switch (offence)
        {
            case "Homework Not Done":
            cmbOffence.setSelectedIndex(1);
            break;
            case "Work Not Submitted":
            cmbOffence.setSelectedIndex(2);
            break;
            case "Lesson Not Attended":
            cmbOffence.setSelectedIndex(1);
            break;
            default:
        }
        ...
        if(opt == 0)
        {
            ...
            if(lblSIDerr.getText().equals("****") && lblOfferr.getText().equals("****") && lblSanerr.getText().equals("****") && lblSuberr.getText().equals("****") && lblPTerr.getText().equals("****") && lblDOOerr.getText().equals("****"))
            {
                ...
                try
                {
                    ...
                    int num = jTDisplay.getSelectedRow();
                    String value = jTDisplay.getModel().getValueAt(num, 0).toString();
                    String query = "UPDATE conLog SET `StudentID` = ?, `Offence` = ?, `Sanction` = ?, `Subject` = ?, `ParentsTold` = ?, `DateOfOffence` = ? WHERE `StudentID` = '" + value + "'";
        ...
        if(opt == 0)
        {
            ...
            if(lblSIDerr.getText().equals("****"))
            {
                ...
                try
                {
                    ...
                    String query = "SELECT * FROM conLog WHERE StudentID = '" + value + "' AND Offence = '" 
    ...
    private void OFF_HNDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OFF_HNDActionPerformed
        // TODO add your handling code here:
        //display data only where offence = homework not done
        Filter("Offence", "Homework Not Done");
    }//GEN-LAST:event_OFF_HNDActionPerformed

    private void OFF_WNSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OFF_WNSActionPerformed
        // TODO add your handling code here:
        //display data only where offence = work not submitted
        Filter("Offence", "Work Not Submitted");
    }//GEN-LAST:event_OFF_WNSActionPerformed
    ...
    private void OFF_LNAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OFF_LNAActionPerformed
        // TODO add your handling code here:
        //display data only where offence = lesson not attended
        Filter("Offence", "Lesson Not Attended");
    }//GEN-LAST:event_OFF_LNAActionPerformed
    ...
    private void sortOFFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sortOFFActionPerformed
        // TODO add your handling code here:
        //sort by offence in ascending order
        Sort("ASC", "Offence");
    }//GEN-LAST:event_sortOFFActionPerformed
    ...
    private javax.swing.JMenuItem OFF_HND;
    private javax.swing.JMenuItem OFF_LNA;
    private javax.swing.JMenuItem OFF_WNS;
    ...
    private javax.swing.JLabel lblOffence;
    private javax.swing.JLabel lblOfferr;
    ...
    private javax.swing.JMenuItem sortOFF;
