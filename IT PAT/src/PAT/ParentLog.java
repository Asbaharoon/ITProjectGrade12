 ...
 * @author eliznab74
 */
public class ParentLog extends javax.swing.JFrame {

    /**
     * Creates new form ParentLog
     */
    ...
    private void initComponents() {
        ...
        lblCellNumber.setForeground(new java.awt.Color(255, 255, 255));
        ...
        cmbRel.setBackground(new java.awt.Color(0, 0, 0));
        cmbRel.setForeground(new java.awt.Color(0, 0, 153));
        cmbRel.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Relationship", "Mother", "Father", "Guardian" }));
        cmbRel.setBorder(null);
        ...
        lblRELerr.setForeground(new java.awt.Color(156, 0, 0));
        ...
        jTDisplay.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "First Name", "Last Name", "Gender", "Relationship", "Cell Number"
            }
        ) {
        ...
        txtCN.setBackground(new java.awt.Color(0, 0, 0));
        txtCN.setForeground(new java.awt.Color(0, 0, 153));
        txtCN.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 3, 1, new java.awt.Color(0, 0, 153)));

        cmbCode.setBackground(new java.awt.Color(0, 0, 0));
        cmbCode.setForeground(new java.awt.Color(0, 0, 153));
        cmbCode.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Code", "+268", "+27" }));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(cmbRel, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(cbMale)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(lblRelationship)
                            .addComponent(cmbRel, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblRELerr)
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void val()
    {
        ...
        try
        {
            ...
            if("Relationship".equals(cmbRel.getSelectedItem().toString()))
            {
                //display message indicating error
                lblRELerr.setText("Relationship must be selected*");
                lblRELerr.setForeground(r);
            }
            //if selected
            else
            {
            ...
            if(txtCN.getText().isEmpty() && cmbCode.getSelectedItem().toString().equals("Code"))
            {
                lblCNerr.setText("Cell Number cannot be left empty");
                lblCNerr.setForeground(r);
            }
            //if text area is not empty
            else
            {
                //if country code selected is south african
                if(cmbCode.getSelectedItem().toString().equals("+27"))
                {
                    //if length of text is not 9
                    if(!(txtCN.getText().length() == 9))
                    {
                        //display error message
                        lblCNerr.setText("South African Cell Number must be 9 numbers in length*");
                        lblCNerr.setForeground(r);
                    }
                    //if length of text is 9
                    else
                    {
                        //check each character of text
                        for(int i = 0; i < txtCN.getText().length(); i++)
                        {
                            //if character at position i is not a number
                            if(!(Character.isDigit(txtCN.getText().charAt(i))))
                            {
                                //display error
                                lblCNerr.setText("Enter only digits*");
                                lblCNerr.setForeground(r);
                            }
                            ...
                            else
                            {
                                ...
                                lblCNerr.setText("****");
                                lblCNerr.setForeground(g);
                                //get cell number in correct format
                                number = "+27 " + txtCN.getText().substring(0,2) + " " + txtCN.getText().substring(2,5) + " " + txtCN.getText().substring(5);
                            }
                        }
                    }
                }
                //if country code selected is swazi
                else if(cmbCode.getSelectedItem().toString().equals("+268"))
                {
                    //if length of text is not 8
                    if(!(txtCN.getText().length() == 8))
                    {
                        //display message indicating error
                        lblCNerr.setText("Swazi Cell Number must be 8 numbers in length*");
                        lblCNerr.setForeground(r);
                    }
                    //if length of text is 8
                    else
                    {
                        //check each character of text
                        for(int i = 0; i < txtCN.getText().length(); i++)
                        {
                            //if character at i is not a number
                            if(!(Character.isDigit(txtCN.getText().charAt(i))))
                            {
                                //display error
                                lblCNerr.setText("Enter only digits*");
                            ...
                            else
                            {
                                ...
                                number = "+268 " + txtCN.getText().substring(0,4) + " " + txtCN.getText().substring(4);
                            }
                        }
                    }
                }
    ...
    {
        ArrayList<Parents> userList = new ArrayList<>();
        try
        {
            ...
            while(rs.next())
            {
                user = new Parents(rs.getString("StudentID"), rs.getString("Firstname"), rs.getString("Lastname"), rs.getString("Gender"), rs.getString("Relationship"), rs.getString("Cellnumber"));
                userList.add(user);
            }
        }
        ...
        ArrayList<Parents> List = userList;
        ...
        for(int i = 0; i < List.size(); i++)
        {
            ...
            row[4] = List.get(i).getRelationship();
            row[5] = List.get(i).getCellnumber();
            model.addRow(row);
        }
    }
        ...
        if(opt == 0)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        //display message indicating error
                        lblSIDerr.setText("Student does not exist*");
                        lblSIDerr.setForeground(r);
                        txtStudentID.setBorder(b);
                        txtStudentID.setForeground(r);
                    }
            ...
            if(lblSIDerr.getText().equals("****") && lblFNerr.getText().equals("****") && lblLNerr.getText().equals("****") && lblRELerr.getText().equals("****") && lblGENerr.getText().equals("****") && lblCNerr.getText().equals("****"))
            {
                //begin try-catch
                try
                {
                    String query = "INSERT INTO `parents`(`StudentID`, `Firstname`, `Lastname`, `Gender`, `Relationship`, `Cellnumber`) VALUES (?, ?, ?, ?, ?, ?)";
                    //get connection to database
                    con = DriverManager.getConnection("jdbc:mysql://localhost/consultations", "root", "");
                    pst = con.prepareStatement(query);
                    ...
                    pst.setString(5, cmbRel.getSelectedItem().toString());
    ...
    private void jTDisplayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTDisplayMouseClicked
        ...
        String rel = model.getValueAt(i, 4).toString();
        switch(rel)
        {
            case "Mother":
            cmbRel.setSelectedIndex(1);
            break;
            case "Father":
            cmbRel.setSelectedIndex(2);
            break;
            default:
            cmbRel.setSelectedIndex(3);
            break;
        }

        String SAnum = model.getValueAt(i, 5).toString().trim().substring(3);
        String SDnum = model.getValueAt(i, 5).toString().trim().substring(4);
        
        String code = model.getValueAt(i, 5).toString().substring(0,2);
        switch(code)
        {
            case "+27":
            cmbCode.setSelectedIndex(2);
            txtCN.setText(SAnum.trim());
            break;
            default:
            cmbCode.setSelectedIndex(1);
            txtCN.setText(SDnum.trim());
            break;
        }
        ...
        if(opt == 0)
        {
            ...
            if(lblSIDerr.getText().equals("****") && lblFNerr.getText().equals("****") && lblLNerr.getText().equals("****") && lblRELerr.getText().equals("****") && lblGENerr.getText().equals("****") && lblCNerr.getText().equals("****"))
            {
                ...
                try
                {
                    ...
                    String query = "UPDATE parents SET `StudentID` = ?, `Firstname` = ?, `Lastname` = ?, `Gender` = ?, `Relationship` = ?, `Cellnumber` = ? WHERE `StudentID` = '" + value + "'";
                    String query2 = "UPDATE studentLog SET `StudentID` = '" + txtStudentID.getText() + "' WHERE `StudentID` = '" + value + "';";
                    pst = con.prepareStatement(query);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(opt == 0)
        {
            ...
            else
            {
                ...
                {
                    con = DriverManager.getConnection("jdbc:mysql://localhost/consultations", "root", "");
                    String query = "SELECT * FROM parents WHERE StudentID = '" + txtStudentID.getText() + "'";
                    pst = con.prepareStatement(query);
                    ResultSet rs = pst.executeQuery(query);
                    ...
                    if(rs.next())
                    {
                        ...
                        try
                        {
                            ...
                            int num = jTDisplay.getSelectedRow();
                            String value = jTDisplay.getModel().getValueAt(num, 0).toString();
                            String query2 = "DELETE FROM parents WHERE StudentID = '" + value + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ParentLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel lblCNerr;
    ...
    private javax.swing.JLabel lblRELerr;
